        ...
        <div class="login_box">
            ...
            <div id="second">
                ...
                <form action="register.php" method="post">
                    ...
                    <?php if (in_array("Your first name must be between 2 and 25 charecter<br>", $error_array)) {
                            echo "Your first name must be between 2 and 25 charecter<br>";
                        }
                    ?>
                    ...
                    <?php if (in_array("Your last name must be between 2 and 25 charecter<br>", $error_array)) {
                            echo "Your last name must be between 2 and 25 charecter<br>";
                        }
                    ?>
